...
const desktopModeProps = {
  ...
  "Home": {
    ...
    "TextBox19": {
      "custom": {
        "text": "Wesite Design for Finanace Startup"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image41": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/diagonal%20arrow.png"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "TextBox181": {
      "custom": {
        "text": "mattis faucibus odio feugiat arcu scelerisque drogon "
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "TextBox33": {
      "custom": {
        "text": "Brand referesh for Technology app"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "TextBox224": {
      "custom": {
        "text": "Lorem ipsum dolar sit amet, consectutar adipiscing, set"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "TextBox225": {
      "custom": {
        "text": "do euismod tempor incidudant ut labor."
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image55": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/ui%20design.svg"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "TextBox263": {
      "custom": {
        "text": "isit anenot . incidudant ut labore et"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image58": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/user%20reasearch.svg"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image29": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/design%20sprints.jpeg"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image30": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/typographie.jpeg"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image31": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/greater%20than.png"
      },
      "callbacks": {
        "onClick": [
          {
